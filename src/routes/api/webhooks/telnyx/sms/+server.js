...
export async function POST({ request }) {
	try {
		...
		// Send webhook payload to otp@secureconnect.app via email
		try {
		...
		try {
			...
			await sendTelnyxResponse(toPhone, fromPhone, 'Verification successful! You can now use SecureConnect Enterprise Chat.');
