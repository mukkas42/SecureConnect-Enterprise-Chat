<script>
	...
	async function handleSave() {
		...
		try {
			...
			const storedSession = browser ? localStorage.getItem('app_session') : null;
			if (storedSession) {
...
<svelte:head>
	<title>{profileUser?.displayName || profileUser?.username || 'User'} - SecureConnect Enterprise Chat</title>
	<meta name="description" content="View {profileUser?.displayName || profileUser?.username || 'user'}'s profile on SecureConnect Enterprise Chat" />
</svelte:head>
			...
			<div class="profile-actions">
				...
				{:else if $isAuthenticated}
					<div class="profile-actions-grid">
						...
						<button class="btn btn-call-voice" on:click={handleVoiceCall} title="Voice Call" aria-label="Start voice call">
							<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
								<path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
							</svg>
						</button>
						
						<button class="btn btn-call-video" on:click={handleVideoCall} title="Video Call" aria-label="Start video call">
							<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
			...
			{:else if userPublicKey}
				<div class="public-key-display">
					<p class="public-key-description">
						This is {isOwnProfile ? 'your' : `${profileUser?.displayName || profileUser?.username || 'this user\'s'}`} end-to-end encryption public key.
						{#if !isOwnProfile}
					...
					<div class="key-info">
						...
						<ul>
							<li><strong>Algorithm:</strong> End-to-End Encryption</li>
							<li><strong>Privacy:</strong> Messages are encrypted on your device</li>
							<li><strong>Security:</strong> Industry-standard cryptographic protocols</li>
						</ul>
					</div>
				</div>
			{:else}
