...
<svelte:head>
	<title>Chat - SecureConnect Enterprise Chat</title>
</svelte:head>
		...
		{#if showWelcome}
			<div class="welcome-banner">
				<div class="welcome-content">
					<h2>🎉 Welcome to SecureConnect Enterprise Chat, {$user?.displayName || $user?.username}!</h2>
			...
			<div class="chat-main" class:show={!showSidebar || !activeConversationId}>
				...
				{:else}
					<div class="chat-welcome">
						...
						<h2>Welcome to SecureConnect Enterprise Chat</h2>
