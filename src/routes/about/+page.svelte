<script>
	...
	const teamMemberInfo = {
		...
		mrpthedev: {
			role: 'Developer',
			bio: 'Talented developer contributing to SecureConnect Enterprise Chat\'s mission of secure communication. Dedicated to building robust and reliable software solutions.',
			socialLinks: []
		}
	};
...
<svelte:head>
	<title>About Us - SecureConnect Enterprise Chat</title>
	<meta name="description" content="Learn about the team behind SecureConnect Enterprise Chat and our mission to build quantum-safe messaging for everyone." />
</svelte:head>
...
<div class="about-page">
	<div class="container">
		<header class="page-header">
			...
			<p class="last-updated">Meet the team behind SecureConnect Enterprise Chat</p>
		</header>
		...
		<div class="content">
			<section class="about-section">
				<h2>🚀 Our Mission</h2>
				<p>
					At SecureConnect Enterprise Chat, we believe that privacy is a fundamental human right. In an era where quantum computers 
			...
			<section class="about-section team-section">
				<h2>👥 Meet the Team</h2>
				<p>SecureConnect Enterprise Chat is built by a passionate team of developers, cryptographers, and privacy advocates.</p>
					...
					{#each data.teamMembers as member}
						...
						<div class="team-member">
							...
							<div class="member-info">
								...
								<p class="member-bio">
									{member.bio || memberInfo?.bio || 'Contributing to SecureConnect Enterprise Chat\'s mission of secure communication.'}
								</p>
			...
			<section class="about-section">
				...
				<p>
					SecureConnect Enterprise Chat is more than just a messaging app - it's a community of privacy-conscious individuals 
			...
			<section class="about-section">
				...
				<ul>
					<li>Email: <a href="mailto:hello@secureconnect.app">hello@secureconnect.app</a></li>
					<li>Support: <a href="mailto:support@secureconnect.app">support@secureconnect.app</a></li>
					<li>Security: <a href="mailto:security@secureconnect.app">security@secureconnect.app</a></li>
				</ul>
			</section>
		</div>
	</div>
