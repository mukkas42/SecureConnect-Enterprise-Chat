...
<svelte:head>
  <title>Community Plugins - SecureConnect Enterprise Chat</title>
  <meta name="description" content="Browse and manage community plugins for SecureConnect Enterprise Chat" />
</svelte:head>
  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
      ...
      <p class="text-blue-800 dark:text-blue-200 mb-2">
        Plugins extend SecureConnect Enterprise Chat with additional functionality. To use a plugin:
      </p>
