<script>
	...
	const socialLinks = [
		{
			name: 'Discord',
			url: 'https://discord.gg/w5nHdzpQ29',
			icon: `<svg fill="currentColor" viewBox="0 0 24 24" style="width: 100%; height: 100%;">
		...
		{
			name: 'X (Twitter)',
			url: 'https://x.com/profullstackinc',
			icon: `<svg fill="currentColor" viewBox="0 0 24 24" style="width: 100%; height: 100%;">
		...
		{
			name: 'Bluesky',
			url: 'https://bsky.app/profile/chovyfu.bsky.social',
			icon: `<svg fill="currentColor" viewBox="0 0 24 24" style="width: 100%; height: 100%;">
...
<footer class="footer">
		...
		<div class="brand-section">
			<div class="brand-header">
				...
				<div class="brand-text">
					<h3>SecureConnect Enterprise Chat</h3>
					<p>Secure Enterprise Messaging</p>
				</div>
			</div>
			
			<p class="brand-description">
				Secure, end-to-end encrypted messaging for your business.
			</p>
		</div>
	...
	<div class="footer-bottom">
		<div class="footer-bottom-content">
			<div class="copyright">
				<span>© {currentYear} SecureConnect Enterprise Chat Team</span>
				<span class="status">All systems operational</span>
			</div>
			
			<div class="badges">
				<div class="badge quantum-safe">
					<div class="badge-dot"></div>
					<span>Secure Messaging</span>
				</div>
				
				<div class="badge nist-approved">
					<div class="badge-dot"></div>
...
<style>
	.footer {
		position: relative;
		background: linear-gradient(180deg, #0a0f18 0%, #000000 100%);
		color: white;
		overflow: hidden;
		margin-top: auto;
