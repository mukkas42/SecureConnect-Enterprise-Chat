/**
 * @fileoverview Client-side key management for SecureConnect Enterprise Chat
...
export class KeyManager {
	constructor() {
		this.storageKey = 'SecureConnect_keys';
		this.storageEncryptionKeyName = 'SecureConnect_storage_enc_key';
	...
	async hasUserKeys() {
		try {
			...
			const userKeys = localStorage.getItem('SecureConnect_user_keys');
			return !!userKeys;
		} catch (error) {
	...
	async generateUserKeys() {
		try {
			...
			localStorage.setItem('SecureConnect_user_keys', JSON.stringify(userKeys));
	...
	async clearUserKeys() {
		try {
			...
			localStorage.removeItem('SecureConnect_user_keys');
	...
	async getUserKeys() {
		try {
			...
			const stored = localStorage.getItem('SecureConnect_user_keys');
