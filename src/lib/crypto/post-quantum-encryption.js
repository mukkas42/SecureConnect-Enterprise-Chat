/**
 * @fileoverview Post-quantum encryption service for SecureConnect Enterprise Chat
...
export class PostQuantumEncryptionService {
	constructor() {
		...
		this.storageKey = 'SecureConnect_pq_keypair';
		this.storageKey768 = 'SecureConnect_pq_keypair_768';
	...
	async generateUserKeys() {
		try {
			...
			if (typeof window !== 'undefined') {
				window.dispatchEvent(new CustomEvent('SecureConnect Enterprise Chat:keys-generated'));
			}
