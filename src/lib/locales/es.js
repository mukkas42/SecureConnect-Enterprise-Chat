export default {
	...
	'warrantCanary.title': 'Canario de Garantía - SecureConnect Enterprise Chat',
	'warrantCanary.heading': 'Canario de Garantía',
	'warrantCanary.intro': 'Esta página sirve como el Canario de Garantía de SecureConnect Enterprise Chat. Si este mensaje se elimina, altera o no se actualiza en el plazo esperado, puede indicar que hemos recibido una orden secreta del gobierno que estamos legalmente impedidos de revelar.',
	'warrantCanary.lastUpdatedLabel': 'Última actualización:',
	'warrantCanary.statement': 'A la fecha anterior, SecureConnect Enterprise Chat no ha recibido ninguna Carta de Seguridad Nacional (NSL), órdenes FISA u otras solicitudes clasificadas de datos de usuarios.',
	...
	// App
	'app.name': 'SecureConnect Enterprise Chat',
