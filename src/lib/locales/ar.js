export default {
	...
	'warrantCanary.title': 'كناري الضمان - SecureConnect Enterprise Chat',
	'warrantCanary.heading': 'كناري الضمان',
	'warrantCanary.intro': 'تعمل هذه الصفحة ككناري الضمان الخاص بـ SecureConnect Enterprise Chat. إذا تم حذف هذه الرسالة أو تغييرها أو عدم تحديثها في الإطار الزمني المتوقع، فقد يشير ذلك إلى أننا تلقينا أمرًا حكوميًا سريًا يُمنع علينا قانونيًا الكشف عنه.',
	'warrantCanary.lastUpdatedLabel': 'آخر تحديث:',
	'warrantCanary.statement': 'اعتبارًا من التاريخ المذكور أعلاه، لم تتلق SecureConnect Enterprise Chat أي رسائل أمن قومي أو أوامر FISA أو طلبات سرية أخرى لبيانات المستخدمين.',
