/**
 * @fileoverview Service Worker for SecureConnect Enterprise Chat PWA
	...
	(async () => {
		...
		try {
			...
			const options = {
				...
				tag: tag || 'SecureConnect Enterprise Chat-message',
...
async function getQueuedMessages() {
	return new Promise((resolve, reject) => {
		const request = indexedDB.open('SecureConnect Enterprise Chat-queue', 1);
