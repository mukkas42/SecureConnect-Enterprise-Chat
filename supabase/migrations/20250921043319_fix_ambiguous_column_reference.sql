-- Fix Ambiguous Column Reference Migration
-- Fixes the ambiguous "conversation_id" column reference in get_user_conversations_enhanced function
...
-- Add comment
COMMENT ON FUNCTION get_user_conversations_enhanced(UUID) IS 'Gets all user conversations with fixed column references - shows all conversations without archive filtering';
