...
-- "Your secureconnect verification code is {{ .Code }}. This code expires in 10 minutes."
...
('phone_verification', 'Your secureconnect verification code is {{ .Code }}. This code expires in 10 minutes.'),
('phone_change', 'Your secureconnect phone change verification code is {{ .Code }}. This code expires in 10 minutes.')
