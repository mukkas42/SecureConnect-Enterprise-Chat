-- Migration: Restore original conversation_name support and add last_message_at
-- Fixes accidental break where conversation_name disappeared
...
returns table (
  ...
  select
    ...
    c.name as conversation_name,         -- keep same alias as before
