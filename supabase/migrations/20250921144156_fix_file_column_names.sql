-- Fix File Column Names in Delete Function
-- Use correct column names: created_by for encrypted_files, and delete attachments via message_id
...
-- Add comment
COMMENT ON FUNCTION delete_encrypted_data_only(UUID, UUID) IS 'Deletes encrypted data only. Uses created_by for encrypted_files, deletes attachments via message_id relationship.';
